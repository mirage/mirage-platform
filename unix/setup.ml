...
(* OASIS_START *)
(* DO NOT EDIT (digest: e3ef5bef06831aa3fc62bf728a48f5e0) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("mirage-unix", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("mirage-unix", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Core platform libraries for Mirage (UNIX and Xen).\nThis provides the `OS` library which handles timers,\ndevice setup and the main loop, as well as the runtime\nfor the Xen microkernel.Page-aligned memory allocator.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "ñ\154¹Nù\148?£n\0079\030j\150=¬";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
